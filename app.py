...
# 2. Section 2.1 Business KPIs (Displaying metrics at the top)
...
# 3. SAP Process Flow Table (Representing real SAP objects and statuses)
...
# 4. Process Validation and Actions (Moving into Step 4 of the O2C flow: Delivery & Picking)
st.write("---")
